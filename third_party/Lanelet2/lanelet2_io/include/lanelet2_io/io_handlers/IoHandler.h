...
public:
    ...
    explicit IOHandler(
            const Projector& projector, const io::Configuration& config = io::Configuration())
...
public:
    ...
    //! using a default projector is not allowed. The implementations define how this issue is
    //! handled.
